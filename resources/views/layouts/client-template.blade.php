  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
                          ...
                          <table class="table table-bordered table-striped" style="width: 100%;" role="grid" aria-describedby="example_info">
                            <thead>
                              ...
                              <tr>
                                ...
                                <td><textarea name="template_desc"id="template_desc" class="form-control" placeholder="Enter template description">{{old('template_desc')}}</textarea></td>
                              </tr>
                              </tr>
                            </thead>
        ...
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
            <a class="btn btn-primary btn-addon btn-md pull-right mb-5 addsenderid" style="margin-bottom:10px; z-index: 99; position:relative;" data-toggle="modal" data-target="#smsSenderIdEditForm"><i class="fa fa-plus"></i> Create New Template</a>
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive">
                        <table ui-jq="dataTable" id="clienttemplate" class="clienttemplate display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Template Title</th>
