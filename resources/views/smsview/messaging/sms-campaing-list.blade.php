        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Pending Campaing List</h1>
              ...
              <div class="col-md-12">
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive dataTables_wrapper">
                        <table class="campainglist display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <!-- <th>ID</th> -->
                              <th>Campaning Title</th>
                              <th>Content Type</th>
                              <th>Campaign Type</th>
                              <th>SMS Content</th>
                              <th>SMS count</th>
