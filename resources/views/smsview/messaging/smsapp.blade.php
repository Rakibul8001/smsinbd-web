...
<script type="text/javascript">
 (function(document, window, $){
      ...
      $('.doverify').on('click', function(){
        ...
        $.ajax({
          url: "{{route('root-client-decument-verify',['user' => $request->user->id])}}",
          method: 'post',
      ...
      $('.dostatus').on('click', function(){
        ...
        $.ajax({
          url: "{{route('root-client-status',['user' => $request->user->id])}}",
          method: 'post',
