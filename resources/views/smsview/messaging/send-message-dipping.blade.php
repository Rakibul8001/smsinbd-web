...
8801500000000" rows="4"></textarea>
                    ...
                    <button type="button" class="btn btn-primary btn-addon btn-md pull-right setsmssenddipping"><i class="fa fa-save"></i> Submit</button>
                  </form>
                </div>
              </div>
            </div>
