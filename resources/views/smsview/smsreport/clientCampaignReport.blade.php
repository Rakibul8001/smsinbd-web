                          ...
                          <thead>
                              <tr>
                                ...
                                if(!Auth::guard('web')->user()){
                                    ...
                                    ?>
                                    <th>
                                      <input type="text" data-column="0"  class="search-input-text" placeholder="Client name" style="max-width: 100px;">
                                    </th>    
                                    <?php
                                }
                                ?>
                                <th>
                                  <input type="text" data-column="{{ $indexCol+0 }}"  class="search-input-text" placeholder="Search ID" style="max-width: 100px;">
                                </th>
                                <th>
                                  <input type="text" data-column="{{ $indexCol+1 }}"  class="search-input-text" placeholder="Name" style="max-width: 100px;">
                                </th>
                                <th>
                                  <input type="text" data-column="{{ $indexCol+2 }}"  class="search-input-text" placeholder="SenderId" style="max-width: 100px;">
                                </th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th>
                                  <input type="text" data-column="{{ $indexCol+7 }}"  class="search-input-text" placeholder="Date" style="max-width: 100px;">
                                </th>
                                <th></th>
                                <th></th>
                              </tr>
...
<script>
  ...
  $(document).ready(function() {
    ...
    var dataTable = $('#singleSmsReport').DataTable( {
      ...
      "ajax":{
        url :"{{ route('campaign-report-data') }}", // json datasource
