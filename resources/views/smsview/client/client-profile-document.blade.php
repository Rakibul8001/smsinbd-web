                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="{{asset('/nid/'.$clientDocuments->nid)}}" height="480px;" width="100%"></iframe>
                              @else 
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              ...
                              @if($clientDocuments)
                                <iframe src="https://docs.google.com/viewer?url={{asset('/applications/'.$clientDocuments->application)}}&embedded=true" height="480px;" width="100%" embedded=true></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                      ...
                      <div class="modal bd-example-modal-lg fade" id="customppModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="{{asset('/clientphoto/'.$clientDocuments->customppphoto)}}" height="480px;" width="100%"></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                            </div>
                      ...
                      <div class="modal bd-example-modal-lg fade" id="tradelicenceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="{{asset('/tradelicence/'.$clientDocuments->tradelicence)}}" height="480px;" width="100%"></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <form role="form" action="{{route('client-document-upload',['userid'=>$user->id])}}" method="post" enctype="multipart/form-data">
                            <div class="panel-heading font-bold">Document List</div>
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <img src="/images/noimage.jpg" alt="" class="gallery1 nidimg" width="100" height="100" onerror="this.src='/images/noimage.jpg';"/>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-md-offset-2 col-sm-2">
                                        <img src="" class="applicationimg" width="100" height="100" onerror="this.src='/images/microsoftnoimage.jpg';"/>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-md-offset-2 col-sm-2">
                                        <img src="" class="custppphotoimg" width="100" height="100" onerror="this.src='/images/noimage.jpg';"/>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-md-offset-2 col-sm-2">
                                        <img src="" class="tradelicenceimg" width="100" height="100" onerror="this.src='/images/tradelicence.png';"/>
                                        </div>
