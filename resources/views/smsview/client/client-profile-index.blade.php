                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row row-sm text-center">
                            ...
                            <div class="panel padder-v item">
                                <div class="h1 text-info font-thin h1">{{$totalsentsms}}</div>
                            ...
                            <a href class="block panel padder-v bg-primary item">
                                <span class="text-white font-thin h1 block">{{$thisweeksentsmsbal}}</span>
                            ...
                            <div class="r bg-light dker item hbox no-border">
                                ...
                                <div class="text-primary-dk font-thin h1"><span>{{$thismonthsentsmsbal}}</span></div>
