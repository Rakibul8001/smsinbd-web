  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
        ...
        <div>
            ...
            <div class="padder">    
                @if(session()->has('msg'))
                    <div class="alert alert-success font-weight-bold clientsuccess" role="alert" style="margin-top: 10px;">
                    {{session()->get('msg')}}
                    </div>
                @endif  
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="panel-heading font-bold">Assigned Senderid</div>
                                            ...
                                            <table ui-jq="dataTable" id="resellerassignedsmssender" class="resellerassignedsmssender display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                                                <thead>
                                                    <tr>
                                                    <th>ID</th>
                                                    <th>Sender ID</th>
                                    ...
                                    <div class="col-md-5 col-xs-12">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body"> 
                                                <form action="{{route('assign-senderids-to-reseller')}}" method="post">
                                                @csrf
