            ...
            <div class="padder" style="margin-top: 20px;">     
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-heading font-bold">EDIT USER <span data-status="{{$user->status}}" class="pull-right doresellerstatus @if($user->status == '') text-danger @elseif($user->status == 'n') text-danger @elseif($user->status == 'y') text-success @endif">Status :@if($user->status == '') No @elseif($user->status == 'n') No @elseif($user->status == 'y') Yes @endif</span></div>
                                <div class="panel-body">
