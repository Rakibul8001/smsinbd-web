...
<div class="container w-xxl w-auto-xs panel" style="    background-color: #2c2323; box-shadow: 0px 1px 3px #000;">
  ...
  <a href class="navbar-brand block m-t">Client Login</a>
  <div class="m-b-lg">
...
<form name="form" class="form-validation" action="{{route('send-password-information')}}" method="POST">
      @csrf
      ...
      <div class="list-group list-group-sm">
        <div class="list-group-item m-b">
            <input type="text" name="identity" id="identity" placeholder="Email or Phone" class="form-control no-border" required>
        </div>
        <input type="hidden" name="requestfor" id="requestfor" value="{{$requestfor}}"/>
        <input type="hidden" name="passwordResetFor" id="passwordResetFor" value="{{$passwordResetFor}}"/>
