   ...
   <div class="row">
       ...
       <div class="col-md-10">
        <div class="col-md-12">
            ...
            <div class="panel-heading font-bold">Client SignUp 
              ...
              <form role="form" action="{{route('doregistration')}}" method="post">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="phone" id="phone" value="{{old('phone')}}" class="form-control" required placeholder="Enter Phone">
                        @error('phone')
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <select ui-jq="chosen" class="w-full clientregistration" name="country" id="country">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" name="state" id="state" value="{{old('state')}}" class="form-control" placeholder="Enter your state">
                      </div>
                  ...
                  <button type="submit" class="btn btn-primary btn-addon btn-md pull-right"><i class="fa fa-save"></i> Save</button>
                </form>
              </div>
            </div>
          </div>
