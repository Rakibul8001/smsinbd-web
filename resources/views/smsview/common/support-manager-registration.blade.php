        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Support Manager Registration</h1>
        ...
        <!-- / main header -->
          <div class="row m-t-md">
            <div class="col-md-9 col-md-offset-2">
              ...
              <div class="panel-heading font-bold">ADD SUPPORT MANAGER </div>
                ...
                <form role="form" action="{{route('doregistration')}}" method="post">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <label class="font-bold">Password <span class="text-danger" style="font-weight: 300;">*[min 6 char lenght]</span></label>
                          <input type="password" name="password" value="{{ old('password') }}" id="password" class="form-control {{$errors->has('password')?'border-danger':''}}" required placeholder="Enter Password">
                          @error('password')
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <input type="text" name="state" id="state" class="form-control" value="{{old('state')}}" required placeholder="Enter your state">
                        </div>
