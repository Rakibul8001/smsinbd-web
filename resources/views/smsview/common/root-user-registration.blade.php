        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Root User Registration</h1>
        ...
        <!-- / main header -->
          <div class="row m-t-md">
            <div class="col-md-9 col-md-offset-2">
              ...
              <div class="panel-heading font-bold">ADD ROOT USER </div>
                ...
                <form role="form" action="{{route('doregistration')}}" method="post">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <input type="hidden" name="usertype" id="usertype" value="root"/>
