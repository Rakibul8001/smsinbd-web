...
<form name="form" class="form-validation" action="{{route('smslogin')}}" method="POST">
      ...
      <button type="submit" class="btn btn-lg btn-primary btn-block m-b">Log in</button>
      
      <a href="{{route('verify-your-phone')}}" class="btn btn-lg btn-default btn-block">Create an account</a>
