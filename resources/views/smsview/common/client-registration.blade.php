        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">User Registration</h1>
          ...
          <div class="row m-t-md">
            <div class="col-md-9 col-md-offset-2">
              ...
              @if(session()->has('errmsg'))
                <div class="alert alert-danger font-weight-bold clienterr" role="alert">
                  {{session()->get('errmsg')}}
                </div>
              @endif
              <div class="panel panel-default">
              <div class="panel-heading font-bold">ADD CLIENT <span class="pull-right"><a href="{{route('reseller')}}" class="btn btn-primary btn-addon btn-md pull-right" style="margin-right: -12px;margin-top: -7px;"><i class="fa fa-close"></i> Close</a></span></div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          @error('company')
                          <span class="text-danger font-weight-bold">{{$errors->first('company')}}</span>
                          @enderror
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          ...
                          <input type="text" name="city" id="city" class="form-control" value="{{old('city')}}" required placeholder="City">
                          @error('city')
                        ...
                        <div class="col-md-2" style="margin-top: 20px;">
                          <label class="checkbox-inline">
                              <input type="checkbox"name="live_dipping" id="live_dipping" value="{{old('live_dipping')}}"> Dipping
                          </label>
                        </div>
