            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel-default dataTables_wrapper">
                        <div class="panel-heading font-bold">Client SMS Sale Form <span class="pull-right" style="top: -7px;position: relative;right: -12px;"><button type="button" class="btn btn-primary btn-addon btn-md pull-left clearinvoice">RESET FORM</button></span>
                            ...
                            <div class="form-group" style="margin-bottom: 30px;">
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-4 col-lg-4 col-sm-4 col-xs-4">
                                        ...
                                        <select ui-jq="chosen" name="invoice_client" id="invoice_client" class="form-control select2">
                                    ...
                                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-4">
                                        ...
                                        <div class="input-group date">
                                            <select name="validity_date" id="validity_date" class="form-control select2" onkeypress="return handleEnter(this, event)">
                                                <option value=""></option>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-3 col-lg-3 col-sm-3 col-xs-3"> 
                                        ...
                                        <select name="sms_type" id="sms_type" class="form-control select2" onkeypress="return handleEnter(this, event)">
                                            <option value=""></option>
                                            <option value="mask">Mask</option>
                                            <option value="nomask">Non Mask</option>
                                            <option value="voice">Voice</option>
                                            <option value="lc">Low Cost</option>
                                        </select>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <select name="paymentoption" id="paymentoption" class="form-control select2" onkeypress="return handleEnter(this, event)">
                                        ...
                                        <tr>
                                            ...
                                            <th class="paymentby">
                                            <select name="paymentby" id="paymentby" class="form-control select2" onkeypress="return handleEnter(this, event)">
                                                <option value="">Select payment method</option>
                                                @foreach($groups['data'] as $group)
                                                    (@if(Auth::guard('reseller')->check() || Auth::guard('root')->check())
