                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="/nid/{{$clientDocuments->nid}}" height="480px;" width="100%"></iframe>
                              @else 
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              ...
                              @if($clientDocuments)
                                <iframe src="https://docs.google.com/viewer?url={{ URL::to('/') }}/applications/{{$clientDocuments->application}}&embedded=true" height="480px;" width="100%" embedded=true></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                      ...
                      <div class="modal bd-example-modal-lg fade" id="customppModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="/nid/{{ $clientDocuments->customppphoto }}" height="480px;" width="100%"></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                            </div>
                      ...
                      <div class="modal bd-example-modal-lg fade" id="tradelicenceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body" style="height: 500px;">
                              @if($clientDocuments)
                                <iframe src="/tradelicence/{{$clientDocuments->tradelicence}}" height="480px;" width="100%"></iframe>
                              @else 
                                <h3 class="text-center">Document Not Upload Yet!</h3>
                              @endif
                            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel panel-default">
                            ...
                            <form role="form" action="{{route('root-client-document-upload',['userid'=>$user->id])}}" method="post" enctype="multipart/form-data">
