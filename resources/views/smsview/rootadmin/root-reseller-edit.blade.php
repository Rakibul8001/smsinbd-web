    ...
    <div class="app-content-body ">
        ...
        <div class="bg-light lter b-b wrapper-md">
            ...
            <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                <h1 class="m-n font-thin h3 text-black font-bold">Reseller Edit</h1>
        ...
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
            ...
            <div class="col-md-12">
              ...
              <a class="btn btn-primary btn-addon btn-md pull-right mb-5" style="margin-bottom:10px; z-index: 9999; position:relative;" href="{{route('root-resellers')}}"><i class="fa fa-angle-left"></i> Back to List</a>
                                      ...
                                      <div class="panel-body">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="row" style="margin-top: 10px;">
                                              <label class="col-sm-2 control-label font-bold">Application <span class="text-danger">*</span></label>
                                              <div class="col-sm-4">
                                            ...
                                            <div class="row" style="margin-top: 10px;">
                                              <label class="col-sm-2 control-label font-bold">Custom PP Photo <span class="text-danger">*</span></label>
                                              <div class="col-sm-4">
                                            ...
                                            <div class="row" style="margin-top: 10px;">
                                              <label class="col-sm-2 control-label font-bold">Trade Licence Copy <span class="text-danger">*</span></label>
                                              <div class="col-sm-4">
