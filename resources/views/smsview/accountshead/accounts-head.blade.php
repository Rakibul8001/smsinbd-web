        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Manage Root Account's Head</h1>
                  ...
                  <div class="panel-heading font-bold">Account's Information</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <label class="font-bold">Root Account's Head <span class="text-danger">*</span></label>
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive">
                        <table ui-jq="dataTable" id="accountshead" class="accountshead display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Acc Head</th>
