    ...
    <div class="app-content-body ">
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Manage Bottom Account's Head</h1>
          ...
          <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title font-bold rootaccountidhead" id="exampleModalLabel">Add Bottom Accounts</h5>
        ...
        <div class="modal bd-example-modal-md fade" id="addsubrootaccountshead" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title font-bold rootaccountidhead" id="exampleModalLabel">Add Group Accounts</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <label class="font-bold">Group Account's Head <span class="text-danger">*</span></label>
              ...
              <div class="modal-footer">
                <input type="hidden" name="account_rec_id" id="account_bottomrec_id"/>
                <input type="hidden" name="accrootfrmmode" id="accrootfrmmode" value="ins"/>
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive">
                        <table ui-jq="dataTable" id="bottomaccountshead" class="bottomaccountshead display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Acc Head</th>
