  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
        ...
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
          ...
          <form role="form" action="{{ route('edit.senderid-post', $senderId->id) }}" method="post">
            @csrf
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default dataTables_wrapper">
                  <div class="panel-heading font-bold">
                    <h4>Edit Sender Id: <b>{{ $senderId->name }}</b></h4>
                  </div>
                  ...
                  <div class="panel-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <label class="font-bold">Master Sender ID <span class="text-danger">*</span></label>
                            <input type="text" name="sender_name" id="sender_name" value="{{ $senderId->name }}" class="form-control" placeholder="Enter Master Senderid Name" required maxlength="13">
                        ...
                        <div class="col-md-6" style="margin-top: 20px;">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="radio">
                              ...
                              <label class="i-checks">
                                <input type="radio" name="type" value="1" {{ $senderId->type==1 ? 'checked' : ''}}>
                                <i></i>
                                Mask
                              </label>
                            </div>
                          ...
                          <div class="col-md-3">
                            <div class="radio">
                              <label class="i-checks">
                                <input type="radio" name="type" value="2" {{ $senderId->type==2 ? 'checked' : ''}}>
                                <i></i>
                                Nonmask
                              </label>
                            </div>
                          ...
                          <div class="col-md-3">
                            <div class="radio">
                              <label class="i-checks">
                                <input type="radio" name="type" value="3" {{ $senderId->type==3 ? 'checked' : ''}}>
                                <i></i>
                                Voice
                              </label>
                            </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="col-md-5">
                            <textarea name="description" id="description" class="form-control" placeholder="Enter Description" maxlength="255">{{ $senderId->description }}</textarea>
                          ...
                          <tr>
                            ...
                            <td>
                              <select name="output_operator[{{$operator->id}}]" class="form-control outputOperator" key="{{$operator->id}}" required>
                                ...
                                @foreach($allOperators as $key => $opt)
                                  <option value="{{ $opt->id }}" {{ $oldOutputOperators[$operator->id] == $opt->id ? 'selected' : '' }}>{{ $opt->name }}</option>
                                @endforeach
                              </select>
                            </td>
                            <td>
                              <select name="gateway[{{$operator->id}}]" id="gateways{{$operator->id}}" class="form-control" required>
                                {!! $oldGatewayOptions[$operator->id] !!}
                              </select>
                            </td>
                            <td>
                              <div class="" id="associateSender{{$operator->id}}" 

                                {!! $oldOutputOperators[$operator->id] == 5 ? 'style="display:none;"' : '' !!}

                                >
                                <input type="text" name="associate_sender[{{$operator->id}}]" class="form-control" placeholder="Enter associate Sender ID" maxlength="13" value="{{ $oldAssociate[$operator->id] }}">
                              </div>
                              <div class="" id="teletalkSender{{$operator->id}}"

                                {!! $oldOutputOperators[$operator->id] == 5 ? '' : 'style="display:none;"' !!}

                               >
                                <input type="text" name="username[{{$operator->id}}]" placeholder="Username" class="form-control" value="{{ $oldUsername[$operator->id] }}">
                                <input type="text" name="password[{{$operator->id}}]" placeholder="Password" class="form-control" value="{{ $oldPass[$operator->id] }}">
                              </div>
                            </td>
                          </tr>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="radio">
                          ...
                          <label class="i-checks">
                            <input type="radio" name="status" id="senderid_status_yes" value="1" {{ $senderId->active == 1 ? 'checked' : '' }} >
                            <i></i>
                            Yes
                          </label>
                        </div>
                      ...
                      <div class="col-md-2">
                        <div class="radio">
                          <label class="i-checks">
                            <input type="radio" name="status" id="senderid_status_no" value="0" {{ $senderId->active == 0 ? 'checked' : '' }}>
                            <i></i>
                            No
                          </label>
                        </div>
                    ...
                    <button type="submit" class="btn btn-success btn-addon btn-md pull-right"><i class="fa fa-plus"></i> Edit Sender ID</button>
