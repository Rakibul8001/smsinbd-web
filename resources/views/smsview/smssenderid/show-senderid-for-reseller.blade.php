...
@section('appbody')
  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Manage Reseller Sender IDs</h1>
        ...
        <div class="modal bd-example-modal-md fade" id="assignsenderidtoreseller" tabindex="-1" role="dialog" aria-labelledby="operatorapiModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <form role="form" action="{{route('assign-reseller-senderid')}}" id="smsoperatorapi" method="post">
                @csrf
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btn-addon btn-md"><i class="fa fa-save"></i> Submit</button>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      @if(Auth::guard('root')->check())  
                      <a href="{{route('reseller-teletalk-senderid',['senderidtype'=>'teletalk'])}}" class="btn btn-primary btn-addon btn-md mb-5" style="margin-bottom:10px; z-index: 99; position:relative; margin-right:20px;"><i class="fa fa-list"></i> Teletalk Senderid</a>  
                      @endif
                      </div>
                      <div class="table-responsive">
                        <table ui-jq="dataTable" id="smssenderidforreseller" class="smssenderidforreseller display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Sender ID</th>
