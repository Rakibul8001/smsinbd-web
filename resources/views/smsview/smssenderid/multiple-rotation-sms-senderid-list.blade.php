...
@section('appbody')
  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
        ...
        <div class="bg-light lter b-b wrapper-md">
            <div class="row">
              ...
              <div class="col-sm-6 col-xs-12 text-right hidden-xs">
                  <h1 class="m-n font-thin h3 text-black font-bold">Manage Multiple Template Rotation Sender IDs</h1>
        ...
        <div class="modal bd-example-modal-md fade" id="smsTemplateSenderIdAddForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form role="form" action="{{ route('add-rotation-multiple-template-sms-senderid') }}" id="smssenderadd" method="post">
                @csrf
              <div class="modal-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group general-senderid" style="margin-top: 10px;">
                          <table class="table table-bordered table-striped" style="width: 100%;" role="grid" aria-describedby="example_info">
                            ...
                            <tbody id="multiple_rotation_associate_senderid_parent">
                            <?php $i = 0; ?>
                            <!-- foreach($operators as $operator) -->
            
                              <tr id="multiple_rotation_associate_senderid0">
                                
                                <td><input type="text" name="associate_sender_id[]"  value="{{old('sender_name'.$i)}}" id="associate_sender_id{{$i}}" class="form-control" placeholder="Enter associate sender id"></td>
                                <td>
                                  <select name="template[]" id="template{{$i}}" class="form-control">
                                    <option selected value="{{old('template'.$i)}}">Select template</option>
                                ...
                                <td>
                                  <select name="gateway[]" id="gateway{{$i}}" class="form-control">
                                ...
                                <td>
                                    <select name="sender_status[]" id="sender_status{{$i}}" class="form-control">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-md mb-5 multiple_deleterotation_associate_senderid" style="margin-bottom:10px; z-index: 99; position:relative;"><i class="fa fa-minus"></i> Delete</a>
                                </td>
                              </tr>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-2">
                              ...
                              <div class="radio">
                                ...
                                <label class="i-checks">
                                  <input type="radio" name="status" id="multiple_template_senderid_status_yes" value="1" checked>
                                  <i></i>
                                  Yes
                                </label>
                              </div>
                            ...
                            <div class="col-md-2">
                              <div class="radio">
                                <label class="i-checks">
                                  <input type="radio" name="status" id="multiple_template_senderid_status_no" value="0">
                                  <i></i>
                                  No
                                </label>
                              </div>
                          ...
                          <div class="col-md-2">
                              ...
                              <div class="radio">
                                ...
                                <label class="i-checks">
                                  <input type="radio" name="default" id="multiple_template_senderid_default_yes" value="1">
                                  <i></i>
                                  Yes
                                </label>
                              </div>
                            ...
                            <div class="col-md-2">
                              <div class="radio">
                                <label class="i-checks">
                                  <input type="radio" name="default" id="multiple_template_senderid_default_no" value="0" checked>
                                  <i></i>
                                  No
                                </label>
                              </div>
        ...
        <div class="modal bd-example-modal-md fade" id="smsTemplateSenderIdEditForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title font-bold senderidhead" id="exampleModalLabel">Add SMS Sender ID</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group general-senderid" style="margin-top: 10px;">
                          <table class="table table-bordered table-striped" style="width: 100%;" role="grid" aria-describedby="example_info">
                            ...
                            <tbody id="multiple_rotation_associate_edit_senderid_parent">
                            <?php $i = 0; ?>
                            <!-- foreach($operators as $operator) -->
            
                              <tr id="multiple_rotation_associate_edit_senderid0">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-md mb-5 multiple_deleterotation_associate_add_senderid" style="margin-bottom:10px; z-index: 99; position:relative;"><i class="fa fa-minus"></i> Delete</a>
                                </td>
                              </tr>
        ...
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
            ...
            <a class="btn btn-primary btn-addon btn-md pull-right mb-5 addsenderid" style="margin-bottom:10px; z-index: 99; position:relative;" data-toggle="modal" data-target="#smsTemplateSenderIdEditForm"><i class="fa fa-plus"></i> Create Turbo Senderid</a>
            @endif
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive">
                        <table ui-jq="dataTable" id="multiplerotationsmssender" class="multiplerotationsmssender display nowrap dataTable dtr-inline collapsed" style="width: 100%;" role="grid" aria-describedby="example_info">
                          <thead>
                            <tr>
                              <th>ID</th>
                              <th>Sender ID</th>
