  ...
  <div id="content" class="app-content" role="main">
    <div class="app-content-body ">
        ...
        <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
            <a class="btn btn-primary btn-addon btn-md pull-right mb-5 addsenderidteletalk" style="margin-bottom:10px; z-index: 99; position:relative; margin-right:20px;" data-toggle="modal" data-target="#smsSenderIdTeletalkAddForm"><i class="fa fa-plus"></i> Create Teletalk Senderid</a>
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <a href="{{route('reseller-senderid',['senderidtype' =>'general'])}}" class="btn btn-primary btn-addon btn-md mb-5" style="margin-bottom:10px; z-index: 99; position:relative;"><i class="fa fa-list"></i> General Senderid</a>
