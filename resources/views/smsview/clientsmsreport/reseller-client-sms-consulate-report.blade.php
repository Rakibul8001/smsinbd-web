              ...
              <div class="col-md-12">
                  <div class="panel panel-default dataTables_wrapper">
                      ...
                      <div class="table-responsive dataTables_wrapper">
                        ...
                        <table class="clientcampaignsmsreport  table table-striped table-hover display nowrap no-footer dtr-inline dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr>
                              <th>CampaignID</th>
                              <th>SenderID</th>
