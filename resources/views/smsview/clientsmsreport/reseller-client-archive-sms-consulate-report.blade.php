                      ...
                      <div class="table-responsive dataTables_wrapper">
                            <div class="container">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12 col-md-offset-2">
                                    ...
                                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                                        <div class="input-group date">
                                            <button type="button" class="btn btn-primary getclietArchiveCampaignsmsreport">Submit</button>
                                        </div>
                                        <span class="text-danger font-bold invoicedateerr" style="display: none;">To date can't left empty</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-left totalcampaignarchive"></div>
                                        <div class="pull-left totalsendsmsarchive"></div>
                                    </div>
                                </div>
                            </div>
                        <table class="clientarchivecampaignsmsreport  table table-striped table-hover display no-footer dtr-inline dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr>
                              <th>CampaignID</th>
                              <th>SenderID</th>
