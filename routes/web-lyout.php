...
Route::get('/reseller', 'ResellerController@reseller')->name('reseller');
...
Route::post('insert-operator-gateway-api', 'GatewayController@addGateWayApi')->name('insert-operator-gateway-api');
...
Route::get('delete-reseller-senderid/{user_sender_id}/{sms_sender_id}','ResellerSenderidController@deleteResellerAssignedSenderId')->name('delete-reseller-senderid');
Route::get('delete-client-senderid/{user_sender_id}/{sms_sender_id}','ClientSenderidController@deleteClientAssignedSenderId')->name('delete-client-senderid');
Route::get('load-assigned-sender-id/{senderid}','ClientSenderidController@loadAssignedSenderId')->name('load-assigned-sender-id');
...
Route::post('reseller-senderids','ResellerSenderidController@resellerSenderidList')->name('reseller-senderids');
Route::post('client-assigned-senderids','ClientSenderidController@clientSenderidList')->name('client-assigned-senderids');
Route::post('reseller-client-assigned-senderids','ResellerClientAssignSenderidController@clientSenderidList')->name('reseller-client-assigned-senderids');
...
Route::get('send-sms','ClientSmsSendController@showSendMsgForm')->name('send-sms');
Route::get('developer-doc','ClientSmsSendController@developerDoc')->name('developer-doc')->middleware('auth:web');
...
Route::post('client-balance','ClientController@clientBalance')->name('client-balance');
...
Route::post('create-contacts','ContactAndGroupController@addContactGroup')->name('create-contacts');
...
Route::post('manage-sms-messages', 'ClientSmsSendController@manageSmsMessage')->name('manage-sms-messages');
...
Route::get('campaign-report','SmsReportController@clientSmsConsulateReport')->name('campaign-report')->middleware('auth:root,reseller,web');
Route::get('archive-campaign-report','SmsReportController@clientArchiveSmsConsulateReport')->name('archive-campaign-report')->middleware('auth:root,reseller,web');
Route::get('campaign-send-data','SmsReportController@clientConsulateSmsSendReport')->name('campaign-send-data')->middleware('auth:root,reseller,web');
...
Route::get('rander-client-template/{userid?}','TemplateController@manageClientTemplate')->name('rander-client-template')->middleware('auth:web,root,manager');
