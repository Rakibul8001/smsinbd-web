...
<head>
  ...
  <title>
    ...
    @elseif(Auth::guard('manager')->check())
      Support Staff SMS Panel ||  login.bdlists.com
    @elseif(Auth::guard('reseller')->check())
      Reseller SMS Panel ||  login.bdlists.com
    @else
      SMS Panel ||  login.bdlists.com
    @endif  
  </title>
...
<script type="text/javascript">
 (function(document, window, $){
      ...
      var renderRotationSenderId = function() {
          $('#rotationsmssender').DataTable().destroy();
          $('#rotationsmssender').DataTable( {
          "order": [[ 0, "desc" ]],  
          "ajax": {
              "processing": true,
              "url": "{{route('rander-sms-senderid',[@$senderidtype])}}",
                  ...
                  { "data": "updated_by" },
                  {
                    "render": function (data, type, full, meta)
                      { 
                        ...
                        {
                          if (full.status == 1 && full.operator_name == null) {
                            return '<a href="#" class="btn btn-sm btn-icon btn-pure btn-default rotationsenderidedtfrm"  data-toggle="modal" data-target="#smsSenderIdTeletalkAddForm" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'" data-gatewayinfo="'+full.rotation_gateway_info+'" data-operatorid="'+full.operator_id+'" data-status="'+full.status+'" data-createdby="'+full.created_by+'" data-updatedby="'+full.updated_by+'" data-default="'+full.default+'" data-user="'+full.user+'" data-password="'+full.password+'"><i class="icon icon-pencil" aria-hidden="true"></i></a>\n\
                            <a href="#" class="btn btn-sm btn-icon btn-pure btn-default assignsenderid"  data-toggle="modal" data-target="#assignsenderid" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'"><i class="fa fa-users" aria-hidden="true"></i></a>\n\
                            <a href="#" class="btn btn-sm btn-icon btn-pure btn-default senderidDtl" data-toggle="tooltip" data-original-title="Remove" data-id="'+full.id+'"> <i class="icon icon-trash" aria-hidden="true"></i></a>'; 
                          } else if (full.status == 1 && full.operator_name != null) {
                            return '<a href="#" class="btn btn-sm btn-icon btn-pure btn-default rotationsenderidedtfrm"  data-toggle="modal" data-target="#smsSenderIdTeletalkAddForm" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'" data-gatewayinfo="'+full.rotation_gateway_info+'" data-operatorid="'+full.operator_id+'" data-status="'+full.status+'" data-createdby="'+full.created_by+'" data-updatedby="'+full.updated_by+'" data-default="'+full.default+'" data-user="'+full.user+'" data-password="'+full.password+'"><i class="icon icon-pencil" aria-hidden="true"></i></a>\n\
                          ...
                          if (full.status == 1 && full.operator_name == null) {
                            return '<a href="#" class="btn btn-sm btn-icon btn-pure btn-default rotationsenderidedtfrm"  data-toggle="modal" data-target="#smsSenderIdAddForm" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'" data-gatewayinfo="'+full.rotation_gateway_info+'" data-operatorid="'+full.operator_id+'" data-status="'+full.status+'" data-createdby="'+full.created_by+'" data-updatedby="'+full.updated_by+'" data-default="'+full.default+'" data-user="'+full.user+'" data-password="'+full.password+'"><i class="icon icon-pencil" aria-hidden="true"></i></a>\n\
                            <a href="#" class="btn btn-sm btn-icon btn-pure btn-default assignsenderid"  data-toggle="modal" data-target="#assignsenderid" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'"><i class="fa fa-users" aria-hidden="true"></i></a>\n\
                            <a href="#" class="btn btn-sm btn-icon btn-pure btn-default senderidDtl" data-toggle="tooltip" data-original-title="Remove" data-id="'+full.id+'"> <i class="icon icon-trash" aria-hidden="true"></i></a>'; 
                          } else if (full.status == 1 && full.operator_name != null) {
                            return '<a href="#" class="btn btn-sm btn-icon btn-pure btn-default rotationsenderidedtfrm"  data-toggle="modal" data-target="#smsSenderIdAddForm" data-original-title="edit" data-id="'+full.id+'" data-sendername="'+full.sender_name+'" data-gatewayinfo="'+full.rotation_gateway_info+'" data-operatorid="'+full.operator_id+'" data-status="'+full.status+'" data-createdby="'+full.created_by+'" data-updatedby="'+full.updated_by+'" data-default="'+full.default+'" data-user="'+full.user+'" data-password="'+full.password+'"><i class="icon icon-pencil" aria-hidden="true"></i></a>\n\
        ...
        if (operatorid == null) {
          ...
          if (gatewayinfo !== null) {
              gatewayinfo.forEach(function(sender){
                ...
                {
                    if (sender.associate_sender_id.indexOf('\"') >= 0) {
                      $('#associate_sender_id'+i).val(sender.associate_sender_id.replace(/\\\"+/g, ' '));
                      $('#gateway'+i).val(sender.associate_gateway);
                    } else {
                      $('#associate_sender_id'+i).val(sender.associate_sender_id);
                      $('#gateway'+i).val(sender.associate_gateway);
                    }
                }
...
<script type="text/javascript">
  (function(document, window, $){
                ...
                $.ajax({
                  ...
                  error: function(err) {
                    console.log(err);
                                      ...
                                      { return '<a href="reseller-client/'+full[0]+'/edit" class="btn btn-sm btn-icon btn-pure btn-default rootuseredtfrm" data-original-title="edit" data-id="'+full[0]+'"><i class="icon icon-pencil" aria-hidden="true"></i></a>\n\
                                        <a href="#" class="btn btn-sm btn-icon btn-pure btn-default viewclientassignedsenderid totalsenderid'+full[0]+'" data-toggle="modal" data-target="#resellerassignedsenders" data-original-title="edit" data-id="'+full[0]+'" data-name="'+full[1]+'" data-mobile="'+full[4]+'"></a>\n\
                                        <a href="#" class="btn btn-sm btn-icon btn-pure btn-default viewbalance" data-toggle="modal" data-target="#clientviewbalance" data-original-title="edit" data-id="'+full[0]+'" data-name="'+full[1]+'" data-mobile="'+full[4]+'"><i class="fa fa-money" aria-hidden="true"></i></a>\n\
      ...
      $('body').on('click','.viewbalance', function(e){
        ...
        let mobile = $(this).data('mobile');
        $.ajax({
          url: "{{route('reseller-client-balance')}}",
          type: "post",
          data: {
            userid: id
          },
