...
class RootClientController extends Controller
{
    ...
    {   
        ...
        if (User::where('id', $request->userid)->exists()) {
            ...
            return view('smsview.client.client-profile',compact('user','countries','request','totalmaskbal','totalnonmaskbal','totalvoicebal'));
        } else {
